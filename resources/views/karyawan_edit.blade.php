                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/karyawan/update/{{ $karyawan->nip }}">
                        ...
                        <div class="form-group">
                            <label>NIP</label>
                            <input type="text" name="nip" class="form-control" placeholder="nip" value=" {{ $karyawan->nip }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="id_jabatan" class="form-control" placeholder="jabatan" value=" {{ $karyawan->id_jabatan }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_tlpn" class="form-control" placeholder="No Telepon" value=" {{ $karyawan->no_tlpn }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control" placeholder="Password" value=" {{ $karyawan->password }}">
